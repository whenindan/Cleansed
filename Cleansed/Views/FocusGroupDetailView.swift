                                    ...
                                    Image(systemName: icon)
                                        ...
                                        .background(
                                            RoundedRectangle(cornerRadius: 8)
                                                .fill(
                                                    editedIcon == icon
                                                        ? Color(hex: editedColorHex).opacity(0.2)
                                                        : Color.clear)
                                        )
                                        .overlay(
                                            RoundedRectangle(cornerRadius: 8)
                                    ...
                                    Circle()
                                        ...
                                        .overlay(
                                            Circle()
                                                .stroke(
                                                    Color.primary,
                                                    lineWidth: editedColorHex == hex ? 3 : 0)
                                        )
                                        .overlay(
                                            Image(systemName: "checkmark")
                                                .font(.caption.bold())
                                                .foregroundStyle(.white)
                                                .opacity(editedColorHex == hex ? 1 : 0)
                                        )
                                }
                                .buttonStyle(.plain)
                            }
                    ...
                    Button {
                        ...
                        HStack {
                            Image(systemName: "app.badge")
                                .foregroundStyle(Color(hex: editedColorHex))
        ...
        VStack(alignment: .leading, spacing: 8) {
            ...
            HStack(spacing: 6) {
                ForEach(1...7, id: \.self) { day in
                    ...
                    Button {
                        if editedWeekdays.contains(day) {
